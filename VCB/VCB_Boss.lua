...
local function AscendingDescendingSec(self, var1, var2)
	if self.casting then
		if VCBrBoss[var1]["Decimals"] == 2 then
			if VCBrBoss[var1]["Sec"] == "Show" then
				if VCBrBoss[var1]["Direction"] == "Ascending" or VCBrBoss[var1]["Direction"] == "Both" then
					var2:SetFormattedText("%.2f sec", self.value)
				elseif VCBrBoss[var1]["Direction"] == "Descending" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.2f sec", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "Hide" then
				if VCBrBoss[var1]["Direction"] == "Ascending" or VCBrBoss[var1]["Direction"] == "Both" then
					var2:SetFormattedText("%.2f", self.value)
				elseif VCBrBoss[var1]["Direction"] == "Descending" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.2f", VCBdescending)
				end
			end
		elseif VCBrBoss[var1]["Decimals"] == 1 then
			if VCBrBoss[var1]["Sec"] == "Show" then
				if VCBrBoss[var1]["Direction"] == "Ascending" or VCBrBoss[var1]["Direction"] == "Both" then
					var2:SetFormattedText("%.1f sec", self.value)
				elseif VCBrBoss[var1]["Direction"] == "Descending" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.1f sec", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "Hide" then
				if VCBrBoss[var1]["Direction"] == "Ascending" or VCBrBoss[var1]["Direction"] == "Both" then
					var2:SetFormattedText("%.1f", self.value)
				elseif VCBrBoss[var1]["Direction"] == "Descending" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.1f", VCBdescending)
				end
			end
		elseif VCBrBoss[var1]["Decimals"] == 0 then
			if VCBrBoss[var1]["Sec"] == "Show" then
				if VCBrBoss[var1]["Direction"] == "Ascending" or VCBrBoss[var1]["Direction"] == "Both" then
					var2:SetFormattedText("%.0f sec", self.value)
				elseif VCBrBoss[var1]["Direction"] == "Descending" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.0f sec", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "Hide" then
				if VCBrBoss[var1]["Direction"] == "Ascending" or VCBrBoss[var1]["Direction"] == "Both" then
					var2:SetFormattedText("%.0f", self.value)
				elseif VCBrBoss[var1]["Direction"] == "Descending" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.0f", VCBdescending)
				end
			end
		end
	elseif self.channeling then
		if VCBrBoss[var1]["Decimals"] == 2 then
			if VCBrBoss[var1]["Sec"] == "Show" then
				if VCBrBoss[var1]["Direction"] == "Descending" or VCBrBoss[var1]["Direction"] == "Both" then
					var2:SetFormattedText("%.2f sec", self.value)
				elseif VCBrBoss[var1]["Direction"] == "Ascending" then
					local VCBdescending = self.maxValue - self.value
					var2:SetFormattedText("%.2f sec", VCBdescending)
				end
			elseif VCBrBoss[var1]["Sec"] == "Hide" then
...
-- Both Time Text --
	...
	for i = 1, 5, 1 do
		...
		_G["Boss"..i.."TargetFrameSpellBar"]:HookScript("OnUpdate", function(self)
			...
			AscendingDescendingSec(self, "CurrentTimeText", _G["VCBcurrentTimeTextBoss"..i])
			AscendingDescendingSec(self, "BothTimeText", _G["VCBbothTimeTextBoss"..i])
			CastBarColor(self)
